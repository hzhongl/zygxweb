        ...
        <div class="col-md-6">
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    ...
                    <li><a href="${pageContext.request.contextPath }/classify.action?lId=${param.lId}&pn=1">首页</a></li>
                    
                    <!--上一页-->
                    <li>
                        <c:if test="${resources.hasPreviousPage}">
                            <a href="${pageContext.request.contextPath }/classify.action?lId=${param.lId}&pn=${resources.pageNum-1}" aria-label="Previous">
                    ...
                    <c:forEach items="${resources.navigatepageNums}" var="page_num">
                        ...
                        <c:if test="${page_num != resources.pageNum}">
                            <li><a href="${pageContext.request.contextPath }/classify.action?lId=${param.lId}&pn=${page_num}">${page_num}</a></li>
                        </c:if>
                    </c:forEach>
                    ...
                    <li>
                        <c:if test="${resources.hasNextPage}">
                            <a href="${pageContext.request.contextPath }/classify.action?lId=${param.lId}&pn=${resources.pageNum+1}"
                               aria-label="Next">
                                <span aria-hidden="true">»</span>
                            </a>
                        </c:if>
                    ...
                    <li><a href="${pageContext.request.contextPath }/classify.action?lId=${param.lId}&pn=${resources.pages}">尾页</a></li>
                </ul>
            </nav>
        </div>
