         ...
         <li class="classify">
          ...
          <ul class="dropdown-menu">
           <c:forEach items="${lables}" var="lable">
            <li><a href="http://127.0.0.1:8080/hxxygx/classify.action?lId=${lable.lId}" >${lable.lLableName}</a></li>
            </c:forEach>
          </ul>
        </li>
      </ul>
...
<div class="index_banner">
         ...
         <c:if test="${resource.lId==1}">
  	<div class="col-md-3">
 	<img src="${resource.rUrl}" width="100%" height="100%"> 
  	...
  	<c:if test="${resource.lId!=1}">
  	 <div class="sub_box clearfix" id="videoBox_new">
          <table class="table table-hover">
            ...
            <td><a href="${pageContext.request.contextPath}/${resource.rUrl}" download="${resource.rName }">下载</a></td>
		</tr>
		</table>
           </div></c:if>
  </c:forEach>
        ...
        <div class="col-md-6">
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    ...
                    <li><a href="http://127.0.0.1:8080/hxxygx/classify.action?lId=${param.lId}&pn=1">首页</a></li>
                    
                    <!--上一页-->
                    <li>
                        <c:if test="${resources.hasPreviousPage}">
                            <a href="http://127.0.0.1:8080/hxxygx/classify.action?lId=${param.lId}&pn=${resources.pageNum-1}" aria-label="Previous">
                    ...
                    <c:forEach items="${resources.navigatepageNums}" var="page_num">
                        ...
                        <c:if test="${page_num != resources.pageNum}">
                            <li><a href="http://127.0.0.1:8080/hxxygx/classify.action?lId=${param.lId}&pn=${page_num}">${page_num}</a></li>
                        </c:if>
                    </c:forEach>
                    ...
                    <li>
                        <c:if test="${resources.hasNextPage}">
                            <a href="http://127.0.0.1:8080/hxxygx/classify.action?lId=${param.lId}&pn=${resources.pageNum+1}"
                               aria-label="Next">
                                <span aria-hidden="true">»</span>
                            </a>
                        </c:if>
                    ...
                    <li><a href="http://127.0.0.1:8080/hxxygx/classify.action?lId=${param.lId}&pn=${resources.pages}">尾页</a></li>
                </ul>
            </nav>
        </div>
